  ...
  return (
    <div className="settings">
      ...
      <div className="set-row">
        ...
        <p className="set-note">
          «ошибка» — агент откажется отправлять запрос, если оценка токенов не влезает в лимит модели;
          «обрезать историю» — выбросит самые старые реплики, уложится в лимит и продолжит диалог
          (потеря памяти будет видна в ответах)
        </p>
      </div>
