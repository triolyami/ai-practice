...
const FILLER =
  ...
  'пересылает всю историю целиком, поэтому промпт-токены накапливаются от хода к ходу. '
const FILLERS = [
  { label: '+10К', size: 10_000, title: 'Вставить ~10 000 символов — заметный рост токенов' },
  { label: '+50К', size: 50_000, title: 'Вставить ~50 000 символов — долгий диалог' },
  { label: '+600К', size: 600_000, title: 'Вставить ~600 000 символов — переполняет контекст glm-4.6 одним сообщением' },
]
