import { COMPRESSION_MODES, DEFAULT_AGENT, MODEL_NOTES } from './constants.js'

const CHATS_KEY = 'day9-chats-v1'
const AGENT_KEY = 'day9-agent-v1'
const SETTINGS_OPEN_KEY = 'day9-settings-open-v1'
...
export function loadAgent() {
  try {
    ...
    return {
      ...
      compression: raw.compression in COMPRESSION_MODES ? raw.compression : DEFAULT_AGENT.compression,
    }
  } catch {
