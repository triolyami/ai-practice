        ...
        {messages.length === 0 && !running && (
          <div className="welcome">
            ...
            <p className="lead">
              ...
              сообщений. В настройках под полем ввода включите формат, лимит
              длины или стоп-последовательность — инструкцией в промпте или
              параметром API; настройки применяются к конкретному сообщению.
            </p>
