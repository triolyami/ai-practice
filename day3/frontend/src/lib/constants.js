...
export const STRATEGIES = [
  { id: 'baseline', title: 'Прямой ответ', hint: 'задача без дополнительных инструкций', model: 'glm-4.6', main: true },
  { id: 'cot', title: 'Пошагово', hint: 'в промпт добавлена инструкция «решай пошагово»', model: 'glm-4.6', main: true },
  { id: 'meta', title: 'Сначала промпт', hint: 'модель сначала пишет промпт для решения, затем решает по нему', model: 'glm-4.6', main: true },
  { id: 'experts', title: 'Группа экспертов', hint: 'аналитик, инженер и критик решают в одном запросе', model: 'glm-4.6', main: true },
  { id: 'experts_multi', title: 'Эксперты по очереди', hint: 'доп.: отдельный запрос каждому эксперту, затем синтез', model: 'glm-4.6', main: false },
  { id: 'thinking', title: 'Нативное рассуждение', hint: 'доп.: glm-5.3 думает сам, без промпт-трюков', model: 'glm-5.3', main: false },
]
