      ...
      <div className="chat-col">
        {messages.length === 0 && !running && (
          <div className="welcome">
            <span className="pill">день 7 · сохранение контекста</span>
            <h1>Чат с агентом</h1>
            <p className="lead">
              Агент хранит историю диалога в SQLite на сервере: перезапуск
              приложения не стирает разговор — при следующем запуске память
              загружается из базы, и диалог продолжается так, как будто агент
              не выключался. Каждый чат слева — отдельный экземпляр агента
              со своей памятью.
            </p>
